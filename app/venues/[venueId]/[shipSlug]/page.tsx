...
export default function VenueShipPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormInstagramUrl(''); setFormTiktokUrl(''); setFormYoutubeUrl(''); setFormFacebookUrl('');
                ...
                {group.reviews.length === 1 ? (
                  (() => { const review = group.reviews[0]; return (
                    <div>
                      ...
                      <SocialIcons instagramUrl={review.instagram_url} tiktokUrl={review.tiktok_url} youtubeUrl={review.youtube_url} facebookUrl={review.facebook_url} size="sm" />
                    </div>
                  ); })()
                ) : (
