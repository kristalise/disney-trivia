...
export const metadata: Metadata = {
  title: "The Ultimate Disney Cruise Companion",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og-secret-menu.jpg",
        width: 1536,
        height: 1024,
        alt: "The Ultimate Disney Cruise Companion — magical compass and treasure map with a cruise ship",
      },
    ],
  },
  twitter: {
